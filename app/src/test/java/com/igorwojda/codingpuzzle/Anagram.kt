...
class AnagramTest {
    ...
    fun `"rail safety" is an anagram of "fairy tales"`() {
        anagrams("rail safety", "fairy tales") shouldBe true
    }
    ...
    fun `"hello" is an anagram of "llohe"`() {
        anagrams("hello", "llohe") shouldBe true
    }

    @Test
    fun `"Whoa! Hi!" is an anagram of "Hi! Whoa!"`() {
        anagrams("Whoa! Hi!", "Hi! Whoa!") shouldBe true
    }

    @Test
    fun `"One One" is not an anagram of "Two two two"`() {
        anagrams("One One", "Two two two") shouldBe false
    }

    @Test
    fun `"One one" is not an anagram of "One one c"`() {
        anagrams("One one", "One one c") shouldBe false
    }

    @Test
    fun `"One one" is not an anagram of "One one  " - ignore spaces`() {
        anagrams("One one", "One one  ") shouldBe true
    }

    @Test
    fun `"A tree, a life, a bench" is not an anagram of "A tree, a fence, a yard"`() {
        anagrams("A tree, a life, a bench", "A tree, a fence, a yard") shouldBe false
    }
}
