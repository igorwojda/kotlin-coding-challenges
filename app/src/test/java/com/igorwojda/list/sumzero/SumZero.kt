...
class SumZeroTest {
    @Test
    fun `sumZero empty list should equals null`() {
        sumZero(listOf()) shouldEqual null
    }

    @Test
    fun `sumZero 1,2 should equals null`() {
        sumZero(listOf(1, 2)) shouldEqual null
    }

    @Test
    fun `sumZero 1,2, 4, 7 should equals null`() {
        sumZero(listOf(1, 2, 4, 7)) shouldEqual null
    }

    @Test
    fun `sumZero -4, -3, -2, 1, 2, 3, 5 equals Pair(-3, 3)`() {
        sumZero(listOf(-4, -3, -2, 1, 2, 3, 5)) shouldEqual Pair(-3, 3)
    }

    @Test
    fun `sumZero -4, -3, -2, 1, 2, 5 equals Pair(-2, 2)`() {
